export let darkModeButton = document.getElementById('darkMode');
export let gameScreen = document.getElementById('fullScreen')
export let darkModeChanger = document.getElementById('modeChangerPicture');
export let difficultyEasy = document.getElementById('difficultyEasy');
